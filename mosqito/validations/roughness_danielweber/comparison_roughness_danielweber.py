...
def comparison_roughness():
    ...
    fig.suptitle('Roughness for a carrier frequency of 250Hz, 1kHz and 4kHz', fontsize=14)
    ...
    axs2.plot(fmod,r_zf[1,:],linestyle='dotted', color='black')
    ...
    axs3.plot(fmod,r_zf[2,:],linestyle='dotted', color='black')
