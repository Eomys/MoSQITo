...
def check_compliance(R, signal):
    ...
    plt.text(0.5, 0.05, 'Maximum difference: ' + str(round(diff)) + ' %', horizontalalignment='center',verticalalignment='center', transform=plt.gca().transAxes)
    plt.text(0.5, 0.15, 'Difference under 30 % in ' + str(prop) + ' % of cases', horizontalalignment='center',verticalalignment='center', transform=plt.gca().transAxes)
    if tst:
