...
def ref_dw(fc, fmod):
    ...
    if fc == 250:
        fm = np.array([  0.7373272,   3.9324117,   9.585254 ,  14.2549925,  16.71275  ,
        ...
        R = np.array([0.00432277, 0.00576369, 0.06340057, 0.16138329, 0.17435159,
    ...
    if fc == 500:
        fm = np.array([  7.6375403,  15.79288  ,  20.841423 ,  26.666666 ,  30.93851  ,
        ...
        R = np.array([0.04972752, 0.1253406 , 0.23569483, 0.35013625, 0.46457765,
    ...
    if fc == 1000:              
        fm = np.array([  0.       ,   3.884415 ,   9.7237625,  17.147604 ,  29.302307 ,
        ...
        R = np.array([0.        , 0.00211198, 0.03450088, 0.1382977 , 0.40437   ,
    ...
    if fc == 2000:
        fm = np.array([  0.       ,   4.4051557,   7.5956764,  10.048887 ,  12.017292 ,
        ...
        R = np.array([0.00271003, 0.00538277, 0.04194128, 0.06631085, 0.10694477,
    ...
    if fc == 4000:
        fm = np.array([  3.1950846,  16.221199 ,  23.840246 ,  29.984638 ,  30.230415 ,
        ...
        R = np.array([0.00432277, 0.11383285, 0.23054755, 0.29538906, 0.31123918,
    ...
    if fc == 8000:
        fm = np.array([  4.6498036,   7.1022663,   8.569778 ,  16.16957  ,  23.037289 ,
        ...
        R = np.array([0.0053807 , 0.02704024, 0.0256728 , 0.08251926, 0.14614701,
