...
def _main_sii(method, speech_spectrum, noise_spectrum, threshold=None):
    ...
    threshold : array_like, optional
        Threshold of hearing [dB ref. 2e-5 Pa] with same size as the chosen method frequency axis.
