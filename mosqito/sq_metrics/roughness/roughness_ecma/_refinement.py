...
def _rho(f, delta_f):
    ...
    _rho = E[theta_corr] - (E[theta_corr]-E[theta_corr-1]) * B[theta_corr]/(B[theta_corr]-B[theta_corr-1])
...
def _refinement(kpi, Phi_E):
    ...
    c1 = Phi_E[kpi] - Phi_E[kpi-1] + (1-2*kpi) * c0
