...
# Local import
from mosqito.conversion import spectrum2dBA


def comp_level(is_stationary, spec_third_dB, fs, unit):
    ...
    if unit =='dB':
        level = 10 * np.log10(sum(np.power(10,spec_third_dB/10)))       
        
    elif unit =='dBA':
        # spectrum A-weighting
        spec_third_dBA = spectrum2dBA(spec_third_dB,fs)
