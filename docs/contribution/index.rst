 ...
 * Start contributing by tackling one of the issues labeled with ["good first issue"](https://github.com/Eomys/MoSQITo/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
 * Implement one of the function listed in the [scope section](scope.md) of the documentation.
